...
public class Heroina extends AbstractActor {   
    ...
    Clau [] claus_recollides = new Clau[5];
    ...
    public boolean haTrobatLesClaus(){
        ...
        if (claus_recollides[4] != null){
            return true;
        }if ((claus_recollides[0] != null) && (claus_recollides[1] != null) && (claus_recollides[2] != null) && (claus_recollides[3] != null)){
             return true;
        }else
             return false; 
        }
    ...
    public void addClau(Clau clau){
        ...
        switch (clau.nom){
            case "Ferro":
                claus_recollides[0] = clau;
                break;
            case "Bronze":
                claus_recollides[1] = clau;
                break;
            case "Llauto":
                claus_recollides[2] = clau;
                break;
            case "Plata":
                claus_recollides[3] = clau;
                break;
            case "Or":
                claus_recollides[4] = clau;
                break;
        }
    }
}
